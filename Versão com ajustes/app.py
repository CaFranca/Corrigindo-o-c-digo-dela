...
rotas_publicas=['static','blueprint.index','blueprint.login']
rotas_privadas=['static','blueprint.musicas', 'blueprint.logout', 'blueprint.limpar', 'blueprint.adicionar_musica', 'blueprint.dashboard']
