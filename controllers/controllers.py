...
def index():
    return redirect(url_for('blueprint_index'))
...
def adicionar_musica():
    ...
    ano_lançamento= request.form.get('ano_lançamento')
    ...
    resp = make_response(redirect(url_for('blueprint')))
